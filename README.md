This is the main branch for the time table project , all the required funcationalities were implimented in the app e.g. landing page , branch selection button <br/>
